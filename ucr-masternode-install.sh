...
COIN_TGZP='https://github.com/ucrcoin/UCR/releases/download/v2.0.0.1/UCR-2.0.0.1-Linux.zip'
COIN_BOOTSTRAP='https://github.com/ucrcoin/UCR/releases/download/v2.0.0.1/bootstrap.zip'
COIN_BOOTSTRAP_NAME=$(echo $COIN_BOOTSTRAP | awk -F'/' '{print $NF}')
COIN_TGZ=$(echo $COIN_TGZP | awk -F'/' '{print $NF}')
COIN_NAME='ucr'
COIN_NAME_OLD='ucrd'
PROJECT_NAME='UltraClear (UCR)'
COIN_EXPLORER='https://explorer.ucrcoin.net/'
COIN_PORT=32628
RPC_PORT=32627
...
cat << EOF > /root/ucr-general-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME General Info: ${NC}"
$COIN_CLI getinfo
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/ucr-general-info

cat << EOF > /root/ucr-fee-info
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
echo -e "${GREEN}$PROJECT_NAME Fee Info: ${NC}"
$COIN_CLI getfeeinfo 100
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/ucr-fee-info

cat << EOF > /root/ucr-networkinfo
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
cat << EOF > /root/ucr-masternode-stats
echo -e "\n\n${BLUE}=======================================================================================================${NC}\n"
...
echo -e "\n${BLUE}=======================================================================================================${NC}\n"
EOF
chmod +x /root/ucr-masternode-stats
...
function important_information() {
 ...
 echo -e "You can also use ${RED}ucr-cli getinfo${NC}, ${RED}ucr-cli getblockcount${NC}, ${RED}ucr-cli getmasternodewinners${NC} and ${RED}ucr-cli getblockchaininfo${NC} commands for a nice looking infos.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
